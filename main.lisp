...
(defpackage :trivial-pis-dependency-aggregator
  ...
  (:export :define-dependency-aggregator-package :*asdf-pathname*))

(defparameter *asdf-pathname* "Specify :PATHNAME of your system e.g. #P\"src/\"." nil) ;; e.g. #P"src/"
(defparameter *dependency-source-dir* (merge-pathnames *asdf-path* (uiop:getcwd)))
